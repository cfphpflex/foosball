...
class Json extends Config
{
    ...
    {
        if(!file_exists(APPLICATION_PATH . '/config/$file')){
            throw new \Jpl\Core\Config\Exception("File: ".$file." does not exist.");
        }
    ...
    protected function getSection($section){
        if(!isset($this->data[$section])){
            throw new \Jpl\Core\Config\Exception("Requested section does not exist");
        }
