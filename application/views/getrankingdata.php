 ...
 <?php   // TODO: move to class later
		 ...
		 //spl_autoload_register('/hr-portal/model/Manager.php');
...
//************* DEFAULT  GET  ALL RECORDS   
	 			if( isset($_POST['_search'])  &&    $_POST['_search'] === 'false'   )   { 
					...
					// 1. SQL stmnt
						$sql = $this->_db->prepare("  select id, fname , lname, title, manager, department, start_date, contractor, status2 from new_hires   where start_date = '{$curdate}'  and status2 = 'New Hire'   order by {$sidx}   {$sord}  ");    
